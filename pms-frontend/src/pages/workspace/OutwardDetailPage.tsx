      ...
      body: (row) => {
        ...
        return (
          <input
            ...
            className="w-full px-2 py-1 text-sm border border-slate-300 rounded focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-right"
          />
        );
      }
    },
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div>
                <span className="text-sm text-slate-500 block mb-1">Issue To</span>
              ...
              {record.closeDate && (
                <div>
                  <span className="text-sm text-slate-500 block mb-1">Close Date</span>
                  <span className="font-medium text-slate-800">
